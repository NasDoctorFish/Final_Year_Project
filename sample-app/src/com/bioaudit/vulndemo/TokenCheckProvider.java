 ...
 *   content://com.bioaudit.vulndemo.tokens/admin  -> one row {status=valid}
 *   content://com.bioaudit.vulndemo.tokens/nobody -> empty cursor (no rows)
 *
 ...
 * oracle side channel that BioAudit's response_oracle detector catches over adb.
...
public class TokenCheckProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        return "vnd.android.cursor.dir/vnd.com.bioaudit.vulndemo.token";
    }
